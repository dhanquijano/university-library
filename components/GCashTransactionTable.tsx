...
interface GCashTransactionTableProps {
...
const GCashTransactionTable: React.FC<GCashTransactionTableProps> = ({
  transactions,
  onVerify,
  onReject,
  onReceiptClick,
      ...
      <div className="rounded-md border">
        <div className="flex items-center justify-center p-12">
          <div className="text-center space-y-2">
            ...
            <div className="text-lg font-medium text-muted-foreground">No GCash transactions found</div>
...
export default GCashTransactionTable;